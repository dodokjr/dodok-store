...
(function ()
{
    ...
    d = function (a, b)
    {
        ...
        c = {
            checks: {
                xhr: {
                    url: function ()
                    {
                        return "/?keyS=" + Math.floor(1e9 * (Math.random() + 1).toString(10).substring(7))
                    },
                    timeout: 5e3
                },
                image: {
                    url: function ()
                    {
                        return "/?keyS=" + Math.floor(1e9 * Math.random())
                    }
                },
                active: "xhr"
            },
        ...
        {
            var d, f;
            return f = null != (d = e(a.options, b)) ? d : e(c, b),
        ...
        a.markUp = function ()
        {
            return a.trigger("confirmed-up"),
                "up" !== a.state ? (a.state = "up",
                    a.trigger("up")) : void 0
        }
        ,
        a.markDown = function ()
        {
            return a.trigger("confirmed-down"),
                "down" !== a.state ? (a.state = "down",
                    a.trigger("down")) : void 0
        }
        ,
        f = {},
        a.on = function (b, c, d)
        ...
        b = function (a, b, c)
        {
            ...
            return h = function ()
            {
                ...
                null === a.onprogress ? (d = a.onerror,
                    ...
                    {
                        return 4 === a.readyState ? h() : 0 === a.readyState && c(),
        ...
        a.checks.xhr = function ()
        {
            ...
            d = new XMLHttpRequest,
                d.offline = !1,
                d.open("POST", a.getOption("checks.xhr.url"), !0),
        ...
        a.check = function ()
        {
            return a.trigger("checking"),
                a.checks[a.getOption("checks.active")]()
        }
        ,
        ...
        a.onXHR = function (a)
        {
            ...
            return e = function (b, c)
            {
                ...
                null != window.XDomainRequest ? (b = window.XDomainRequest,
        ...
        d = Offline.reconnect = {},
            ...
            e = function ()
            {
                ...
                return null != d.state && "inactive" !== d.state && Offline.trigger("reconnect:stopped"),
                    d.state = "inactive",
                    d.remaining = d.delay = null != (a = Offline.getOption("reconnect.initialDelay")) ? a : 3
            }
            ,
            b = function ()
            {
            ...
            g = function ()
            {
                return "connecting" !== d.state ? (d.remaining -= 1,
            ...
            h = function ()
            {
                return "waiting" === d.state ? (Offline.trigger("reconnect:connecting"),
                    d.state = "connecting",
            ...
            a = function ()
            {
                return Offline.getOption("reconnect") ? (e(),
                    d.state = "waiting",
    ...
    function ()
    {
        ...
        c = [],
            ...
            e = function (a)
            {
                ...
                for (c in e)
                    i = e[c],
                        j.setRequestHeader(c, i);
                return j.mimeType && j.overrideMimeType(j.mimeType),
                    j.send(b)
            }
            ,
            a = function ()
                    ...
                    Offline.onXHR(function (a)
                    {
                        ...
                        return g = a.xhr,
                            ...
                            g.offline !== !1 && (f = function ()
                            {
                                ...
                                ,
                                e) ? null === g.onprogress ? (g.addEventListener("error", f, !1),
                                    g.addEventListener("timeout", f, !1)) : (b = g.onreadystatechange,
                                        g.onreadystatechange = function ()
                                        {
                                            return 0 === g.readyState ? f() : 4 === g.readyState && (0 === g.status || g.status >= 12e3) && f(),
    ...
    function ()
    {
        ...
        for (d = ["up", "down"],
            ...
            c = d.length; c > b; b++)
            e = d[b],
                (document.querySelector("script[data-simulate='" + e + "']") || localStorage.OFFLINE_SIMULATE === e) && (null == Offline.options && (Offline.options = {}),
    ...
    function ()
    {
        ...
        b = '<div class="offline-ui"><div class="offline-ui-content"></div></div>',
            a = '<a href="" class="offline-ui-retry"><i class="bi bi-wifi-off" style="color:#000;"></i></a>',
            f = function (a)
            {
                var b;
            ...
            l = function ()
            {
                ...
                return g = f(b),
                    ...
                    null != Offline.reconnect && Offline.getOption("reconnect") && (g.appendChild(f(a)),
            ...
            j = function ()
            {
                return l(),
                    ...
                    {
                        return d("offline-ui-connecting"),
                            k("offline-ui-waiting")
                    }),
                    Offline.on("reconnect:tick", function ()
                    {
                        var a, b, c;
                        return d("offline-ui-waiting"),
                    ...
                    {
                        return k("offline-ui-connecting offline-ui-waiting"),
                            e.setAttribute("data-retry-in-value", null),
                            e.setAttribute("data-retry-in-unit", null)
                    }),
                    Offline.on("reconnect:failure", function ()
                    {
                        return h("offline-ui-reconnect-failed-2s", 2),
                            h("offline-ui-reconnect-failed-5s", 5)
                    }),
                    Offline.on("reconnect:success", function ()
                    {
                        return h("offline-ui-reconnect-succeeded-2s", 2),
                            h("offline-ui-reconnect-succeeded-5s", 5)
                    })
            }
            ,
            "complete" === document.readyState ? j() : null != document.addEventListener ? document.addEventListener("DOMContentLoaded", j, !1) : (c = document.onreadystatechange,
                document.onreadystatechange = function ()
                {
                    return "complete" === document.readyState && j(),
